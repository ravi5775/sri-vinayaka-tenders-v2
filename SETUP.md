...
cd sri-vinayaka-tenders-v2/backend
cp .env.example .env
```
...
**Terminal 2 — Frontend:**
```bash
cd sri-vinayaka-tenders-v2     # Project root (NOT backend/)
npm install
...
```bash
cd ~
git clone https://github.com/ravi5775/sri-vinayaka-tenders-v2.git v2
cd v2/backend
cp .env.example .env
nano .env
```
